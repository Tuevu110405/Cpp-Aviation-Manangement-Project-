...
vector<double> Location::calculateDistance_in_KM(float lat1, float lon1, float lat2, float lon2)
{
...
double Location::Distance_in_NM() {
    return calculateDistance_in_KM / 60;
}
