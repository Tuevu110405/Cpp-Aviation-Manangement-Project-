...
PilotStandard DataManagement::findPilotStandard(const string &model)
{
...
// Function DataManagement::displayPilotStandards (Hoang)
void DataManagement::displayPilotStandards(const string &model)
{
